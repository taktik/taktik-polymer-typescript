...
export declare class OzoneCollection extends Polymer.Element {
     ...
     * @private
     */
    _updateSource(sourceId: string): void;
    /**
     ...
     * @return {any}
     */
    deleteItems(ids: Array<uuid>, reflect?: boolean): any;
    /**
     ...
     * @return {any}
     */
    deleteOne(id: uuid, reflect?: boolean): any;
    _removeOne(id: uuid): void;
    _verifySource(): void;
}
