...
define("ozone-item-abstract-view", ["require", "exports", "decorators", "ozone-type-api", "mediaUrl"], function (require, exports, decorators_1, ozone_type_api_1, mediaUrl_1) {
    "use strict";
    ...
    exports.OzoneItemAbstractView = Polymer.dedupingMixin(function (superClass) {
        let OzoneItemAbstractViewClass = class OzoneItemAbstractViewClass extends superClass {
            ...
            connectedCallback() {
                this.ozoneTypeApi = ozone_type_api_1.getOzoneTypeAPI();
            ...
            loadImage(data, size) {
                return __awaiter(this, void 0, void 0, function* () {
                    size = size || mediaUrl_1.OzonePreviewSize.Small;
        ...
        OzoneItemAbstractViewClass = __decorate([
            decorators_1.customElement('ozone-item-abstract-view')
