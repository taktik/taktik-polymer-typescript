...
define(["require", "exports", "decorators", "ozone-item-api"], function (require, exports, decorators_1, ozone_item_api_1) {
    "use strict";
    ...
    let OzoneCollection = class OzoneCollection extends Polymer.Element {
        ...
        ready() {
            super.ready();
            if (!this._source) {
                this._source = ozone_item_api_1.getOzoneItemAPI();
            }
        }
        /**
         * @private
        ...
        quickSearch(searchString, size) {
            size = size || 10;
            let searchQuery = new ozone_item_api_1.SearchQuery();
    ...
    OzoneCollection = __decorate([
        decorators_1.customElement('ozone-collection')
    ], OzoneCollection);
